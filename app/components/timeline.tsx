            ...
            <Collapse in={AITOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                    <ListItem sx={{ pl: 4 }}>
                        ...
                        <ListItemText secondary="Semester long research problem at AIT Budapest where 
                        I am investigating the role of artificial intelligence in modern software engineering." />
                    </ListItem>
                </List>
            </Collapse>
